        ...
        <div className="max-h-[75vh] overflow-y-auto p-6">
            ...
            <div className="rounded-[1.5rem] border border-slate-200 bg-slate-50 p-5">
              ...
              <div className="mt-4 space-y-3">
                <FeeRow
                  ...
                  value={`RM ${reservation.reservationFee.toFixed(2)}`}
                  note="Fixed one-time fee"
                />

                <FeeRow
                  label="After 7PM Parking Fee"
                  value={
                    reservation.after7ParkingFee > 0
                      ? `RM ${reservation.after7ParkingFee.toFixed(2)}`
                      : "RM 0.00"
                  }
            ...
            <div className="rounded-[1.5rem] border border-slate-200 bg-slate-50 p-5">
              ...
              <div className="mt-4">
                ...
                <select
                  ...
                  onChange={(event) =>
                    onUpdateStatus(reservation.id, event.target.value)
                  }
          ...
          <div className="mt-6 rounded-[1.5rem] border border-cyan-100 bg-cyan-50 p-5">
            ...
            <p className="mt-2 text-sm leading-6 text-slate-600">
              Student/staff reservation fee is a fixed one-time charge.
              Student/staff normal parking is free from 7:00 AM to 7:00 PM.
              Parking fee is only charged after 7:00 PM based on actual usage.
            </p>
          </div>
